...
INSERT INTO "new_Analysis" ("analysisJson", "commentPosted", "commentPostedAt", "confidence", "createdAt", "draftComment", "enrichedRequestJson", "estimatedComplexity", "groundedResponseJson", "id", "jiraCommentId", "model", "pipelineType", "retrievalContextJson", "ticketDescription", "ticketKey", "ticketStatus", "ticketSummary", "ticketType", "ticketUrl") SELECT "analysisJson", "commentPosted", "commentPostedAt", "confidence", "createdAt", "draftComment", "enrichedRequestJson", "estimatedComplexity", "groundedResponseJson", "id", "jiraCommentId", "model", "pipelineType", "retrievalContextJson", "ticketDescription", "ticketKey", "ticketStatus", "ticketSummary", "ticketType", "ticketUrl" FROM "Analysis";
DROP TABLE "Analysis";
